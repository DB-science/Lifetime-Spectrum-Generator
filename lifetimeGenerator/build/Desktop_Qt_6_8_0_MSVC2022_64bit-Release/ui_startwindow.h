...
public:
    ...
    QLabel *label;
    QPushButton *B_idealSpectra;
    QHBoxLayout *horizontalLayout_2;
    QLabel *label_2;
    QPushButton *B_PulseGenerator;
    ...
    void setupUi(QMainWindow *StartWindow)
    {
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/justSpectra.png")));

        horizontalLayout->addWidget(label);

        B_idealSpectra = new QPushButton(centralwidget);
        B_idealSpectra->setObjectName("B_idealSpectra");
        QSizePolicy sizePolicy(QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(B_idealSpectra->sizePolicy().hasHeightForWidth());
        B_idealSpectra->setSizePolicy(sizePolicy);
        QFont font;
        font.setFamilies({QString::fromUtf8("Arial Black")});
        font.setPointSize(16);
        font.setBold(true);
        font.setItalic(false);
        B_idealSpectra->setFont(font);

        horizontalLayout->addWidget(B_idealSpectra);
        ...
        QBrush brush13(QColor(19, 19, 19, 127));
        brush13.setStyle(Qt::SolidPattern);
#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 0)
        palette1.setBrush(QPalette::Disabled, QPalette::PlaceholderText, brush13);
#endif
        QBrush brush14(QColor(27, 27, 27, 255));
        brush14.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Disabled, QPalette::Accent, brush14);
        label_2->setPalette(palette1);
        label_2->setFrameShape(QFrame::Shape::NoFrame);
        label_2->setPixmap(QPixmap(QString::fromUtf8(":/Pulse.png")));
        label_2->setWordWrap(false);

        horizontalLayout_2->addWidget(label_2);

        B_PulseGenerator = new QPushButton(centralwidget);
        B_PulseGenerator->setObjectName("B_PulseGenerator");
        sizePolicy.setHeightForWidth(B_PulseGenerator->sizePolicy().hasHeightForWidth());
        B_PulseGenerator->setSizePolicy(sizePolicy);
        QFont font1;
        font1.setFamilies({QString::fromUtf8("Arial Black")});
        font1.setPointSize(16);
        font1.setWeight(QFont::Black);
        B_PulseGenerator->setFont(font1);
        B_PulseGenerator->setFocusPolicy(Qt::FocusPolicy::StrongFocus);

        horizontalLayout_2->addWidget(B_PulseGenerator);
    ...
    {
        StartWindow->setWindowTitle(QString());
        label_3->setText(QCoreApplication::translate("StartWindow", "This Software is written by Dominik Boras and Danny Petschke (All right reserved 2024)", nullptr));
        label->setText(QString());
        B_idealSpectra->setText(QCoreApplication::translate("StartWindow", "Ideal Spectra-Generator", nullptr));
        label_2->setText(QString());
        B_PulseGenerator->setText(QCoreApplication::translate("StartWindow", "PMT Pulse-Stream-Generator", nullptr));
    } // retranslateUi
